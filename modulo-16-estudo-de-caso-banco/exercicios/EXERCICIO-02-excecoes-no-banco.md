...
O `sacar` da `Conta` falha em silêncio: valores inválidos são simplesmente ignorados. Depois do módulo 08, você tem a ferramenta certa para consertar isso — e vai sentir na pele o efeito de mudar o "contrato" de um método já usado por outras classes.
