...
public class ContaCorrente extends Conta {
    ...
    /*
     * Decisão do item 3 do enunciado: tratamos AQUI com try/catch, em vez de
     * propagar com throws. Motivo: o fechamento mensal processa varias contas em
     * sequência — uma conta sem saldo para a tarifa não deve interromper as
     * demais. A tarifa não descontada vira um aviso (num sistema real, seria
    ...
    public void descontarTarifaMensal() {
        try {
            ...
            System.out.printf("Conta %d: tarifa nao descontada (faltam R$ %.2f).%n",
